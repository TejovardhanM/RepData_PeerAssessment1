...
hist(actsteps$stepsperday, xlab="No of steps", ylab= "interval", main= "Mean total number of steps taken per day"
...
plot(avgactivity$AvgSteps, type="l", main = "Average daily activity pattern", xlab = "Interval", ylab = "Average steps", col="orangered")
